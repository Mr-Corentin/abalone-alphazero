...
class GameLogger:
    ...
    """
    def __init__(self, bucket_name: str, process_id, buffer_size: int = 64, flush_interval: int = 200):
        """
...
class LocalGameLogger:
    ...
    """
    def __init__(self, output_dir: str, buffer_size: int = 64, flush_interval: int = 200):
        """
